...
- **Updates**: Persistent version upgrade tracking (`123Todo_Last_Seen_Version`), automatic PWA update banner + 1-click "Check for Updates" control in Footer & Settings header (`v2.5.7`).
...
- **Bold Text & Header Bar Optimization**: User configurable Bold Font checkbox under Settings ➔ Appearance & streamlined compact project bar (`v2.5.7`).
