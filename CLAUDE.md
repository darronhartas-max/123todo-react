...
- **Updates**: Persistent version upgrade tracking (`123Todo_Last_Seen_Version`), automatic PWA update banner + 1-click "Check for Updates" control in Footer & Settings header (`v2.5.6`).
...
- **Bold Text & Compact View**: User configurable Bold Font checkbox under Settings ➔ Appearance & compact density mode default for new users (`v2.5.6`).
