...
- **Updates**: Persistent version upgrade tracking (`123Todo_Last_Seen_Version`), automatic PWA update banner + 1-click "Check for Updates" control in Footer & Settings header (`v2.5.4`).
- **Voice Task & Voice Notes**: Web Speech API continuous dictation with text appending & automatic Top Priority assignment (`v2.5.4`).
