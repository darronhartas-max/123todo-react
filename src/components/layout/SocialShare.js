...
const SocialShare = () => {
    ...
    const shareText = encodeURIComponent('Check out 123 ToDo - Simple, FREE powerful task management with offline support!');
    const shareUrl = encodeURIComponent('https://123todo.com');

    return (
        <div style={styles.adPanel}>
            <span style={{ fontSize: isMobile ? '0.7rem' : '0.75rem', marginRight: isMobile ? '0' : '8px' }}>
